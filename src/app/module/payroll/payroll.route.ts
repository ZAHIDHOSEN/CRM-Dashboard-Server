...
// advance
 router.get("/analytics",checkAuth(UserRole.ADMIN,UserRole.LEADER),PayrollController.getPayrollAnalytics)
 router.patch("/:id/status",checkAuth(UserRole.ADMIN,UserRole.LEADER),PayrollController.updatePayroll)
...
router.delete("/:id",checkAuth(UserRole.ADMIN,UserRole.LEADER),PayrollController.deletePayroll)
